...
def main():
    ...
    if os.path.isdir('/usr/lib/aarch64-linux-gnu/lxpanel/plugins/'):
        call(["cp", "battSW.so", "/usr/lib/aarch64-linux-gnu/lxpanel/plugins/"])
    else:
        call(["cp", "battSW.so", "/usr/lib/arm-linux-gnueabihf/lxpanel/plugins/"])
    print('after copying');
    CONFIG = None
    ...
    if index >= 0:
        ...
        return 0
    print(CONFIG)
    TEST = common.ReplaceBetween(CONFIG, 'type=dhcpcdui\n  Config {\n  }\n}\n', 'Plugin {\n', MYPLUGIN+"\n")
